...
function release(e){
    if ((e.keyCode == 65 || e.keyCode == 68) && twoPview)
        game.p1.dx = 0;
    else if ((e.keyCode == 65 || e.keyCode == 68) && !twoPview)
        game.p1.dy = 0;

    if ((e.keyCode == 87 || e.keyCode == 83) && twoPview)
        game.p1.dy = 0;
    else if ((e.keyCode == 87 || e.keyCode == 83) && !twoPview)
        game.p1.dx = 0;

    if ((e.keyCode == 74 || e.keyCode == 76) && twoPview)
        game.p2.dx = 0;
    else if ((e.keyCode == 74 || e.keyCode == 76) && !twoPview)
        game.p2.dy = 0;

    if ((e.keyCode == 73 || e.keyCode == 75) && twoPview)
        game.p2.dy = 0;
    else if ((e.keyCode == 73 || e.keyCode == 75) && !twoPview)
        game.p2.dx = 0;
}
